...
- `essay.md` — единый документ с титульным листом, логами работы с AI,
  независимой верификацией, техническим приложением и финальным текстом
  доклада.

Вспомогательные проверяемые артефакты:
